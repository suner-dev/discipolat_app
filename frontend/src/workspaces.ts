...
const FULL_NAV: WorkspaceSection[] = [
  {
    ...
    items: [
      ...
      { name: 'Assistant Vocal', href: '/voice-assistant', icon: Mic, subtitle: 'Commandes vocales PasteurBot' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Passeport spirituel', href: '/passport', icon: ShieldCheck, subtitle: 'Historique vérifiable & portable' },
      ...
      { name: 'Exports de données', href: '/exports', icon: Download, subtitle: 'Exporter rapports & données' },
      { name: 'Imports de données', href: '/import', icon: Upload, subtitle: 'Importer CSV & fichiers' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: 'Aide d\'urgence', href: '/emergency-aid', icon: AlertTriangle, subtitle: 'Gestion des urgences' },
      { name: 'Échange d\'aide', href: '/aid-exchange', icon: ArrowLeftRight, subtitle: 'Troc solidaire' },
      { name: 'Statut 2FA', href: '/2fa-status', icon: ShieldCheck, subtitle: 'Sécurité comptes' },
      { name: 'Santé IA', href: '/ai-health', icon: HeartPulse, subtitle: 'Diagnostic IA' },
      { name: 'Risques IA', href: '/ai-predictions/risks', icon: AlertTriangle, subtitle: 'Prédiction risques' },
      ...
      { name: 'QR Check-in', href: '/qr-checkin', icon: ClipboardCheck, subtitle: 'Présence QR' },
      { name: 'Stats réseau', href: '/network/stats', icon: BarChart3, subtitle: 'Métriques réseau' },
      { name: 'Voix', href: '/voices', icon: Mic, subtitle: 'Rapports vocaux' },
      { name: 'Workflow', href: '/workflow', icon: Workflow, subtitle: 'Automatisation' },
      { name: 'Reconnaissance faciale', href: '/face-recognition', icon: Eye, subtitle: 'Identification' },
      { name: 'Jumeau numérique', href: '/twin-snapshot', icon: Brain, subtitle: 'Snapshot IA' },
      { name: 'Certificats', href: '/reward-certificates', icon: Award, subtitle: 'Récompenses' },
      { name: 'Sermons', href: '/sermons', icon: BookOpen, subtitle: 'Bibliothèque' },
      { name: 'Plans développement', href: '/development-plans', icon: TrendingUp, subtitle: 'Croissance' },
      { name: 'Rapports département', href: '/department-reports', icon: FileText, subtitle: 'Reporting' },
      ...
      { name: 'Conversations', href: '/conversations', icon: MessageCircle, subtitle: 'Messagerie' },
      { name: 'Formations', href: '/courses', icon: GraduationCap, subtitle: 'Cours & modules' },
      { name: 'Équipement', href: '/equipment', icon: Wrench, subtitle: 'Matériel' },
      { name: 'Budgets', href: '/budgets', icon: Wallet, subtitle: 'Gestion budgétaire' },
    ],
  },
];
