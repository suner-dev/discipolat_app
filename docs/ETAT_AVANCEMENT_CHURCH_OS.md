...
| G2.1 | ✅ | 2026-09-14 | | OrganizationNode hierarchy infinite (ltree path) |
| G2.2 | ✅ | 2026-09-14 | | Module catalog (ModuleFeatureController) |
| G2.3 | ✅ | 2026-09-14 | | Custom fields & forms (CustomFieldController) |
| G2.4 | ✅ | 2026-09-14 | | Event bus / outbox (EntityPropagationPublisher) |
| G2.5 | ✅ | 2026-09-14 | | Real-time WebSocket/STOMP (WebSocketConfig + StreamChat) |
| G2.6 | ✅ | 2026-09-14 | | Spaces configurable (DEPARTMENT/FAMILY/SUB_TEAM types) |
| G2.7 | ✅ | 2026-09-14 | | Custom statuses (status transitions in OrganizationNode) |
| G2.8 | ✅ | 2026-09-14 | | Outbox & domain events (EntityPropagationPublisher) |
| G2.9 | ✅ | 2026-09-14 | | Real-time event propagation (SSE useRealtimeSync) |
| G2.10 | ✅ | 2026-09-14 | | Config cache invalidation (SSE + React Query) |
| G2.11 | 🔵 | | | Gate G2 - in progress |
