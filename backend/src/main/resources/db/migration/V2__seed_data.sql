...
-- Passwords are set to 'password123' by the DataInitializer component at startup
-- The hashes here are placeholders that get overwritten
...
VALUES
    ('a0000000-0000-0000-0000-000000000001', 'pasteur@discipolat.com', 'PLACEHOLDER', 'Pierre', 'Apotre', 'PASTEUR', false, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('a0000000-0000-0000-0000-000000000004', 'chef1@discipolat.com', 'PLACEHOLDER', 'Timothee', 'Fils', 'FAISEUR', true, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('a0000000-0000-0000-0000-000000000005', 'chef2@discipolat.com', 'PLACEHOLDER', 'Tite', 'Fidele', 'FAISEUR', true, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('a0000000-0000-0000-0000-000000000006', 'faiseur1@discipolat.com', 'PLACEHOLDER', 'Luc', 'Medecin', 'FAISEUR', false, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('a0000000-0000-0000-0000-000000000007', 'faiseur2@discipolat.com', 'PLACEHOLDER', 'Marc', 'Evangeliste', 'FAISEUR', false, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
    ('b0000000-0000-0000-0000-000000000001', 'Departement Jeunesse', 'Suivi des jeunes disciples de 15-25 ans', 'a0000000-0000-0000-0000-000000000002', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b0000000-0000-0000-0000-000000000002', 'Departement Adultes', 'Suivi des disciples adultes', 'a0000000-0000-0000-0000-000000000003', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- ============================================================
-- FAMILIES
-- ============================================================
INSERT INTO families (id, nom, departement_id, chef_famille_id, date_creation, statut, created_at, updated_at)
VALUES
    ('c0000000-0000-0000-0000-000000000001', 'Famille Timothee', 'b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', CURRENT_DATE, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('c0000000-0000-0000-0000-000000000002', 'Famille Tite', 'b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000005', CURRENT_DATE, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('c0000000-0000-0000-0000-000000000003', 'Famille Fidele', 'b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000004', CURRENT_DATE, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('c0000000-0000-0000-0000-000000000004', 'Famille Esperance', 'b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000005', CURRENT_DATE, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Assign chef de famille relationships
...
-- SAMPLE ACTIVE ALERT
-- ============================================================
INSERT INTO alerts (id, ame_id, faiseur_id, type_alerte, message, date_declenchement, statut, created_at, updated_at)
VALUES
    ('f0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000007', 'ABSENCE_48H', 'Claire Durand - Absence prolongee detectee (plus de 48h sans contact)', CURRENT_TIMESTAMP - INTERVAL '2 days', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
