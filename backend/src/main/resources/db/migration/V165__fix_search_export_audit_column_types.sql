...
ALTER TABLE search_audit ALTER COLUMN entity_types TYPE JSONB USING entity_types::jsonb;

-- export_audit: columns_exported TEXT[] -> JSONB
ALTER TABLE export_audit ALTER COLUMN columns_exported TYPE JSONB USING columns_exported::jsonb;