...
-- Espace Membre : departements du membre (many-to-many), profil disciple enrichi,
-- departements ministeres (Chorale, Audiovisuel).

-- ============================================================
-- PROFIL DISCIPLE ENRICHI (niveau d'etude, nombre d'enfants)
-- ============================================================
...
-- Etendre la contrainte situation_familiale (Espace Membre : parent celibataire)
...
-- ============================================================
-- MEMBER_DEPARTMENTS — Un membre (âme) peut appartenir a plusieurs departements
-- ============================================================
...
VALUES
    ('b0000000-0000-0000-0000-000000000003', 'Chorale', 'Ministere de louange et de musique',
