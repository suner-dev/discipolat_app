...
-- Le pasteur, le responsable, le chef de famille et le faiseur peuvent creer
-- des alertes ciblant une personne, un departement, une famille, un groupe ou l'eglise.

-- ============================================================
-- 1. Rendre ame_id et faiseur_id optionnels (alertes d'eglise / departement)
-- ============================================================
...
-- Etendre les types d'alerte automatiques
...
COMMENT ON COLUMN alerts.priorite IS 'Priorite : BASSE, MOYENNE, HAUTE, URGENTE';
COMMENT ON COLUMN alerts.type_alerte_manuel IS 'Type libre pour les alertes creees manuellement';
