...
class MessageBubble extends StatelessWidget {
          ...
          Flexible(
            child: Column(
              ...
              children: [
                Text(
                  'Réponse',
                  style: TextStyle(fontSize: 9, fontWeight: FontWeight.w500, color: AppColors.primary),
                ),
                Text(
  ...
  Widget _buildMediaContent() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: message.isOwn ? AppColors.primary.withOpacity(0.9) : AppColors.cardDark,
        borderRadius: BorderRadius.only(
          topLeft: const Radius.circular(18),
          topRight: const Radius.circular(18),
          bottomLeft: Radius.circular(message.isOwn ? 18 : 4),
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Icon(message.type == MessageType.video ? Icons.videocam_rounded : Icons.audiotrack_rounded, size: 48, color: Colors.white54),
                      const SizedBox(height: 8),
                      Text(
                        message.content.isEmpty ? message.type.name : message.content,
      ...
      child: Row(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 10, color: message.isOwn ? Colors.white70 : AppColors.surface.withOpacity(0.5)),
          ),
          if (message.isOwn) ...[
            const SizedBox(width: 4),
            Icon(
              ...
              size: 12,
              color: message.reactions.isNotEmpty ? AppColors.success : Colors.white70,
            ),
          ],
        ],
      ),
        ...
        children: message.reactions.entries.map((entry) {
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: hasReacted ? AppColors.primary.withOpacity(0.2) : AppColors.surfaceDark,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: hasReacted ? AppColors.primary : AppColors.surface.withOpacity(0.3)),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  ...
                  if (users.length > 1) ...[
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: hasReacted ? AppColors.primary : AppColors.surface.withOpacity(0.7),
                      ),
                    ),
                  ],
                ],
