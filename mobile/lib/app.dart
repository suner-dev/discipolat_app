...
import 'presentation/screens/platform/platform_admin_dashboard_screen.dart';
import 'presentation/screens/platform/platform_audit_screen.dart';
import 'presentation/screens/platform/platform_registration_requests_screen.dart';
import 'presentation/screens/platform/platform_impersonation_screen.dart';
...
class AuthState {
  ...
  List<String> get platformRoles => _platformRoles;
...
Map<String, List<String>> _routeRoles = {
  ...
  '/platform/dashboard': ['PLATFORM_SUPER_ADMIN'],
  '/platform/audit': ['PLATFORM_SUPER_ADMIN'],
...
final appRouter = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    if (state.matchedLocation == '/accept-invitation') return null;
    ...
    if (auth.isPlatformSuperAdmin &&
        (state.matchedLocation.startsWith('/platform/') ||
            state.matchedLocation == '/admin/tenants')) {
      return null;
    }
  ...
  routes: [
    ...
    GoRoute(
        path: '/streaming',
        name: 'streaming',
        builder: (ctx, s) => const StreamsScreen()),
    GoRoute(
        path: '/streaming/:id',
        name: 'stream-detail',
        builder: (ctx, s) =>
            StreamDetailScreen(streamId: int.parse(s.pathParameters['id']!))),
    GoRoute(
    ...
    GoRoute(
        ...
        name: 'stream-chat',
        builder: (ctx, s) =>
            StreamingChatScreen(streamId: int.parse(s.pathParameters['id']!))),
    GoRoute(
        path: '/events',
        name: 'events',
    ...
    GoRoute(
        path: '/events/create',
        name: 'event-create',
        builder: (ctx, s) => const EventCreateScreen()),
    GoRoute(
        path: '/finances',
        name: 'finances',
        builder: (ctx, s) => const FinancesScreen()),
    GoRoute(
        path: '/health',
        name: 'health',
        builder: (ctx, s) => const HealthScreen()),
    GoRoute(
        path: '/assets',
        name: 'assets',
    ...
    GoRoute(
        path: '/discipleship',
        name: 'discipleship',
        builder: (ctx, s) => const DiscipleshipScreen()),
    GoRoute(
        path: '/surveys',
        name: 'surveys',
    ...
    GoRoute(
        path: '/conversations',
        name: 'conversations',
        builder: (ctx, s) => const msg_conv.ConversationsScreen()),
    GoRoute(
        path: '/messages/new-direct',
        name: 'new-direct-message',
        builder: (ctx, s) => const Scaffold(
            body: Center(
                child: Text('Nouvelle discussion privée - à implémenter')))),
    GoRoute(
        path: '/messages/new-group',
        name: 'new-group',
        builder: (ctx, s) => const Scaffold(
            body: Center(child: Text('Nouveau groupe - à implémenter')))),
    GoRoute(
        path: '/messages/new-channel',
        name: 'new-channel',
        builder: (ctx, s) => const Scaffold(
            body: Center(child: Text('Nouveau canal - à implémenter')))),
    GoRoute(
        path: '/ai-chat',
        name: 'ai-chat',
    ...
    GoRoute(
        ...
        builder: (ctx, s) => const PlatformAdminDashboardScreen()),
    GoRoute(
        path: '/platform/audit',
        name: 'platform-audit',
        builder: (ctx, s) => const PlatformAuditScreen()),
    GoRoute(
        path: '/platform/onboarding',
        name: 'platform-onboarding',
        builder: (ctx, s) => const SuperAdminProvisioningScreen()),
    GoRoute(
        path: '/platform/registration-requests',
        name: 'platform-registration-requests',
        builder: (ctx, s) => const PlatformRegistrationRequestsScreen()),
    GoRoute(
        path: '/platform/impersonation',
        name: 'platform-impersonation',
        builder: (ctx, s) => const PlatformImpersonationScreen()),
    GoRoute(
