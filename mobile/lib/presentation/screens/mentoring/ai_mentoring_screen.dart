...
class _AiMentoringScreenState extends State<AiMentoringScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() { _error = AppLocalizations.of(context).aiMentoringError; _loading = false; });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context).aiMentoringTitle), backgroundColor: Colors.deepPurple, foregroundColor: Colors.white),
      body: _loading
          ...
          : _error != null
              ...
              : _items.isEmpty
                  ? Center(child: Text(AppLocalizations.of(context).aiMentoringEmpty))
                  : RefreshIndicator(
                      onRefresh: _load,
