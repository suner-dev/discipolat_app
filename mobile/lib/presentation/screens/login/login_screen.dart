              ...
              child: FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: () => context.go('/accept-invitation'),
                      icon:
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text('Comptes de démonstration (bêta)',
                                    style: TextStyle(
                            ...
                            const SizedBox(height: 8),
                            _demoAccount(
                                'Admin (multi-rôles)', 'admin@discipolat.com'),
                            _demoAccount('Pasteur', 'pasteur@discipolat.com'),
                            _demoAccount('Responsable (multi-rôles)',
                                'responsable@discipolat.com'),
                            _demoAccount(
