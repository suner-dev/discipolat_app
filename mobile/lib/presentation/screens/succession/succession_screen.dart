...
class _SuccessionScreenState extends State<SuccessionScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() { _error = AppLocalizations.of(context).successionError; _loading = false; });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context).successionTitle), backgroundColor: Colors.brown, foregroundColor: Colors.white),
      body: _loading
          ...
          : _error != null
              ...
              : _items.isEmpty
                  ? Center(child: Text(AppLocalizations.of(context).successionEmpty))
                  : RefreshIndicator(
                      onRefresh: _load,
