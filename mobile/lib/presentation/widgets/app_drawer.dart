...
class _AppDrawerState extends State<AppDrawer> {
  ...
  static const List<Map<String, Object>> _mainNav = [
    ...
    {
      'icon': Icons.description_rounded,
      'title': 'Rapport faiseur',
      'route': '/reports/maker'
    },
    {
      'icon': Icons.group_work_rounded,
      'title': 'Rapport famille',
    ...
    {'icon': Icons.map_outlined, 'title': 'Visites', 'route': '/visits'},
    {
      ...
      'title': 'Suivis parallèles',
      'route': '/parallel-followups'
    },
    {
      'icon': Icons.swap_horiz_rounded,
      'title': 'Transferts',
    ...
    },
    {
      ...
      'title': 'Réseau inter-églises',
      'route': '/network'
    },
    {
      'icon': Icons.upload_file_rounded,
      'title': 'Config espace (lecture)',
      'route': '/space-config-transfer'
    },
  ...
  static const List<Map<String, Object>> _adminNav = [
    ...
    },
    {
      ...
      'route': '/encouragements'
    },
    {
      'icon': Icons.compare_arrows_rounded,
      'title': 'Benchmark églises',
      'route': '/church-comparison'
    },
    {
      'icon': Icons.mood_rounded,
      'title': 'Sabbath Dashboard',
      'route': '/sabbath-dashboard'
    },
    {
    ...
    },
    {
      ...
      'title': 'Prédiction charge',
      'route': '/load-prediction'
    },
    {
      'icon': Icons.location_on_rounded,
      'title': 'Santé quartiers',
      'route': '/neighborhood-health'
    },
    {
  ...
  static const List<Map<String, Object>> _platformNav = [
    ...
    },
    {
      ...
      'title': 'Demandes d\'églises',
      'route': '/platform/registration-requests'
    },
    {
  ...
  static const List<Map<String, Object>> _faiseurNav = [
    ...
    },
    {
      ...
      'title': 'Journal Prophétique',
      'route': '/prophetic-journal'
    },
    {'icon': Icons.book_rounded, 'title': 'Prières', 'route': '/prayers'},
    {
      'icon': Icons.favorite_border_rounded,
  ...
  static const List<Map<String, Object>> _membreNav = [
    ...
    },
    {
      ...
      'title': 'Mes activités',
      'route': '/dashboard/membre/activities'
    },
    {'icon': Icons.book_rounded, 'title': 'Prières', 'route': '/prayers'},
    {
      'icon': Icons.favorite_border_rounded,
  ...
  static String navTitle(String route, AppLocalizations l10n) {
    switch (route) {
      ...
      case '/dashboard/pasteur':
        return l10n.navShepherdsPilot;
      case '/search':
        return l10n.navSearch;
      case '/map':
        return l10n.navMap;
      case '/souls':
        return l10n.navSouls;
      case '/families':
        return l10n.navFamilies;
      case '/crm-faiseur':
        return l10n.navCrmFaiseur;
      case '/dashboard/chef-famille':
        return l10n.navChefDashboard;
      case '/dashboard/responsable':
        return l10n.navRespDashboard;
      case '/departments':
        return l10n.navDepartments;
      case '/reports':
        return l10n.navReports;
      case '/reports/maker':
        return l10n.navMakerReport;
      case '/reports/family':
        return l10n.navFamilyReport;
      case '/prayers':
        return l10n.navPrayers;
      case '/prayers/actions-de-grace':
        return l10n.navGraceActions;
      case '/events':
        return l10n.navEvents;
      case '/evangelism':
        return l10n.navEvangelism;
      case '/objectives':
        return l10n.navObjectives;
      case '/visits':
        return l10n.navVisits;
      case '/parallel-followups':
        return l10n.navParallelFollowups;
      case '/transfers':
        return l10n.navTransfers;
      case '/admin/transfers':
        return l10n.navTransferWorkflow;
      case '/evaluations':
        return l10n.navEvaluations;
      case '/discipline':
        return l10n.navDiscipline;
      case '/alerts':
        return l10n.navAlerts;
      case '/members/requests':
        return l10n.navRequests;
      case '/documents':
        return l10n.navDocuments;
      case '/appointments':
        return l10n.navAppointments;
      case '/messages':
        return l10n.navMessaging;
      case '/badges':
        return l10n.navBadges;
      case '/quest':
        return l10n.navQuest;
      case '/giving':
        return l10n.navTithesOfferings;
      case '/tontines':
        return l10n.navTontines;
      case '/voice-reports':
        return l10n.navVoiceReports;
      case '/voice-assistant':
        return l10n.navVoiceAssistant;
      case '/ai-assistant':
        return l10n.navAiAssistant;
      case '/ai-predictions':
        return l10n.navAiPredictions;
      case '/prophetic-journal':
        return l10n.navPropheticJournal;
      case '/face-checkin':
        return l10n.navFaceCheckin;
      case '/trainings':
        return l10n.navTrainings;
      case '/finances':
        return l10n.navFinances;
      case '/communications':
      ...
      case '/admin/dictionaries':
        return l10n.navDictionaries;
      case '/admin/integrations':
        return l10n.navIntegrations;
      case '/admin/tenants':
        return l10n.navChurches;
      case '/platform/dashboard':
        return 'Dashboard plateforme';
      case '/platform/onboarding':
        return 'Provisionnement guidé';
      case '/platform/registration-requests':
        return 'Demandes d\'églises';
      ...
      case '/permissions':
        return l10n.navPermissions;
      case '/audit':
        return l10n.navAudit;
      case '/compliance':
        return l10n.navCompliance;
      case '/whatsapp-reminders':
        return l10n.navWhatsApp;
      case '/moderation':
        return l10n.navModeration;
      case '/data-migration':
        return l10n.navDataMigration;
      case '/usage-analytics':
        return l10n.navUsageAnalytics;
      case '/encouragements':
        return l10n.navEncouragements;
      case '/church-comparison':
        return l10n.navChurchBenchmark;
      case '/sabbath-dashboard':
        return l10n.navSabbath;
      case '/rewards':
        return l10n.navRewards;
      case '/weekly-challenges':
        return l10n.navWeeklyChallenges;
      case '/growth-projection':
        return l10n.navGrowthProjection;
      case '/load-prediction':
        return l10n.navLoadPrediction;
      case '/neighborhood-health':
        return l10n.navNeighborhoodHealth;
      case '/follow-up-requests':
        return l10n.navFollowUpRequests;
      case '/discipleship-path':
        return l10n.navDiscipleshipPath;
      case '/dashboard/membre':
        return l10n.navDashboard;
      case '/dashboard/membre/activities':
        return l10n.navDashboard;
      default:
        return route;
    }
  ...
  static String _roleLabel(String role, AppLocalizations l10n) {
    switch (role) {
      ...
      case 'PASTEUR':
        return l10n.rolePasteur;
      case 'RESPONSABLE':
        return l10n.roleResponsable;
      case 'CHEF_DE_FAMILLE':
        return l10n.roleChefFamille;
      case 'FAISEUR':
        return l10n.roleFaiseur;
      case 'MEMBRE':
        return l10n.roleMembre;
      case 'PLATFORM_SUPER_ADMIN':
  ...
  Future<void> _switchRole(String newRole) async {
    ...
    try {
      ...
      final response =
          await api.post('/auth/switch-role', data: {'role': newRole});
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(AppLocalizations.of(context).roleSwitchFailed)),
        );
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final auth = AuthState();
    final activeRole =
        auth.isPlatformSuperAdmin ? 'PLATFORM_SUPER_ADMIN' : auth.activeRole;
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: _roleColor(activeRole).withValues(alpha: 0.3)),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(_roleIcons[activeRole] ?? Icons.person,
                            size: 14, color: _roleColor(activeRole)),
                  ...
                  if (allRoles.length > 1) ...[
                    ...
                    InkWell(
                      onTap: () =>
                          setState(() => _showRoleMenu = !_showRoleMenu),
                      child: Row(
                        children: [
                          Icon(Icons.swap_horiz,
                              ...
                              size: 16),
                          const SizedBox(width: 6),
                          Text(AppLocalizations.of(context).navChangeRole,
                              style: TextStyle(
                                  color: Colors.white.withValues(alpha: 0.4),
                                  fontSize: 11)),
                          Icon(
  ...
  List<Widget> _buildNavWithAdminSection(BuildContext context,
      List<Map<String, Object>> items, String activeRole) {
    final adminRoutes = _adminNav.map((e) => e['route']).toSet();
    final mainItems =
        items.where((item) => !adminRoutes.contains(item['route'])).toList();
    final adminItems =
        items.where((item) => adminRoutes.contains(item['route'])).toList();
      ...
      widgets.add(Padding(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(AppLocalizations.of(context).navAdminSection,
                style: const TextStyle(
