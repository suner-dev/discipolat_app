...
void main() {
  group('VolunteersScreen', () {
    testWidgets('renders app bar', (tester) async {
      await tester.pumpWidget(MaterialApp(home: VolunteersScreen(apiService: _FakeApiService())));
    ...
    testWidgets('shows empty state', (tester) async {
      await tester.pumpWidget(MaterialApp(home: VolunteersScreen(apiService: _FakeApiService(empty: true))));
      await tester.pumpAndSettle();
      expect(find.text('Aucun bénévole enregistré.'), findsOneWidget);
    });

    testWidgets('shows error state with retry', (tester) async {
      await tester.pumpWidget(MaterialApp(home: VolunteersScreen(apiService: _FakeApiService(fail: true))));
      await tester.pumpAndSettle();
