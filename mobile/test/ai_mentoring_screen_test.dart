...
void main() {
  group('AiMentoringScreen', () {
    testWidgets('renders app bar', (tester) async {
      await tester.pumpWidget(MaterialApp(home: AiMentoringScreen(apiService: _FakeApiService())));
    ...
    testWidgets('shows empty state', (tester) async {
      await tester.pumpWidget(MaterialApp(home: AiMentoringScreen(apiService: _FakeApiService(empty: true))));
      await tester.pumpAndSettle();
      expect(find.text('Aucune suggestion. Générez-en depuis le web.'), findsOneWidget);
    });

    testWidgets('shows error state with retry', (tester) async {
      await tester.pumpWidget(MaterialApp(home: AiMentoringScreen(apiService: _FakeApiService(fail: true))));
      await tester.pumpAndSettle();
