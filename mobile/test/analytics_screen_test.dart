...
void main() {
  group('EngagementAnalyticsScreen', () {
    testWidgets('renders app bar', (tester) async {
      await tester.pumpWidget(MaterialApp(home: EngagementAnalyticsScreen(apiService: _FakeApiService())));
    ...
    testWidgets('shows empty state', (tester) async {
      await tester.pumpWidget(MaterialApp(home: EngagementAnalyticsScreen(apiService: _FakeApiService(empty: true))));
      await tester.pumpAndSettle();
      expect(find.text('Aucune métrique enregistrée.'), findsOneWidget);
    });

    testWidgets('shows error state with retry', (tester) async {
      await tester.pumpWidget(MaterialApp(home: EngagementAnalyticsScreen(apiService: _FakeApiService(fail: true))));
      await tester.pumpAndSettle();
